...
class EpubBuilder {
    ...
    *getImagePanelView(imagePath, pageWidth, pageHeight) {
        ...
        var imageFileName = (0, _path.basename)(imagePath);
    ...
    *buildOpfFile(imageFilePaths, htmlFilePaths, generatedFilePath, uuid, title) {
        ...
        var spineDirection = "rtl";
        if (options.direction === "ltr") {
            writingMode = "horizontal-lr";
            spineDirection = "ltr";
        }
        var orientation = "portrait";
        var regionMagnification = "false";
        if (options.regionMagnification) {
            regionMagnification = "true";
        }
    ...
    *resizeImages(filePaths, width, height) {
        ...
        try {
            for (var _iterator6 = filePaths[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
